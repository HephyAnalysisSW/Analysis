...
public:
    ...
    void kinRecoMassLoop(const LV& leptonMinus, const LV& leptonPlus, const VLV* jets, const std::vector<float>* btags, const LV* met);
...
private:
    ...
    void angle_rot(const float& alpha, const float& e, const TLorentzVector& inJet, TLorentzVector& jet_sm)const;
...
private:
    ...
    std::map<Channel::Channel, float> m_scaleFactor_;
